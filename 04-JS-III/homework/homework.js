...
function diaDeLaSemana(numeroDeDia) {
  ...
  /*La declaración switch evalúa una expresión, comparando el valor 
  de esa expresión con una instancia case, y ejecuta declaraciones asociadas a ese case,
